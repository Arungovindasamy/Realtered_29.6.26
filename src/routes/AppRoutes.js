      ...
      <Routes>
       ...
       <Route path="/onboarding" element={<OnboardingPage />} />
        ...
        <Route element={<DashboardLayout />}>
          ...
          <Route path="/dashboard/haatzup"              element={<HaatzaUpPage />} />
          <Route path="/dashboard/haatzup/upload-reel"  element={<UploadReelPage />} />
          <Route path="/haatzup"                        element={<HaatzaUpPage />} />
