...
const HAATZA_FUNCTIONS_BASE = "https://haatza.com/_functions";
...
export const incrementInventory = async (payload) => {
  try {
    console.log("[incrementInventory] payload:", payload);
    ...
    console.log("[incrementInventory] response:", response.data);
    return response.data;
  } catch (error) {
...
export const decrementInventory = async (payload) => {
  try {
    console.log("[decrementInventory] payload:", payload);
    const response = await axios.post(
    ...
    console.log("[decrementInventory] response:", response.data);
    return response.data;
  } catch (error) {
...
export const getTickets = async ({ email, fromDate, toDate, count = 50, lastFetched = 0 } = {}) => {
  if (process.env.NODE_ENV !== "production") {
    console.log("[sellerService] getTickets params:", { email, fromDate, toDate, count, lastFetched });
  }
  ...
  if (process.env.NODE_ENV !== "production") {
    console.log("[sellerService] getTickets response:", res.data);
  }
  return res.data;
};
...
export const createTicket = async (ticketData) => {
  if (process.env.NODE_ENV !== "production") {
    console.log("[sellerService] createTicket payload:", ticketData);
  }
  ...
  if (process.env.NODE_ENV !== "production") {
    console.log("[sellerService] createTicket response:", res.data);
  }
  return res.data;
};
...
export const processSubscriptionOrder = async (payload) => {
  ...
  try {
    ...
    console.log("[processSubscriptionOrder] response:", response.data);
    console.log("[processSubscriptionOrder] response", response.data);
    return response.data;
  } catch (error) {
...
export const walletService = {
  ...
  createSellerInvoice: async (payload) => {
    try {
      console.log("[sellerService] createSellerInvoice payload:", payload);
      const res = await axios.post("https://haatzaseller.com/_functions/createSellerInvoice", payload, {
        headers: { "Content-Type": "application/json" },
        timeout: 15000,
      });
      console.log("[sellerService] createSellerInvoice response:", res.data);
      return res.data;
    } catch (err) {
